...
const SignUp = () => {
  ...
  useEffect(() => {
    ...
    setEmail("");
    setPassword("");
  }, [registeredUser, loading, error, googleLoading]);
    ...
    <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <Link href="./sign-in" className="font-semibold ml-1 leading-6 text-indigo-600 hover:text-indigo-500">
            Sign in.
          </Link>
        </p>
      </div>
